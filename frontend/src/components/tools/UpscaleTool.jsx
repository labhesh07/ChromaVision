...
export default function UpscaleTool() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${API_BASE}/upscale/process-json`, formData, {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div className="glass-panel" style={{ padding: '2rem' }}>
        <h2 style={{ marginBottom: '0.5rem' }}>Upscale</h2>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', fontSize: '0.95rem' }}>
          Real-ESRGAN general x4 upscaling. Fast and effective for most images.
        </p>
