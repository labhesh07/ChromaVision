...
export default function RestoreTool() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${API_BASE}/restore/process-json`, formData, {
  ...
  return (
    <div style={{ maxWidth: '800px', margin: '0 auto' }}>
      <div className="glass-panel" style={{ padding: '2rem' }}>
        <h2 style={{ marginBottom: '0.5rem' }}>Old Photo Restore</h2>
        <p style={{ color: 'var(--text-secondary)', marginBottom: '2rem', fontSize: '0.95rem' }}>
          Best for portraits with visible faces. Backgrounds are enhanced with Real-ESRGAN upscaler.
        </p>
